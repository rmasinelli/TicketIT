...
export const SEED_TICKETS = [
  {
    ...
    submittedBy: "u1",
    assignedTo: "u5",
    description: "Lab laptop stopped connecting after a config change. Other devices on the same switch are fine.",
    created: new Date(now - 5 * 3600000).toISOString(),
    notes: [{ author:"u5", text:"Checking SSID config and IP lease.", ts: new Date(now - 4 * 3600000).toISOString() }],
    linkedCourse: null, labScenarioId: null, week: null,
  },
  {
    id: "TKT-002",
    title: "PC won't POST after RAM install",
    courseId: "hw",
    ...
    submittedBy: "u2",
    assignedTo: null,
    description: "Installed new RAM kit, now machine gives 3 beeps and won't boot. RAM is seated in slots A1/B1.",
